...
exports.renderRpgMap = renderRpgMap;
...
function buildLayout(rooms) {
    ...
    for (const room of rooms) {
        if (!byDepth.has(room.depth))
            byDepth.set(room.depth, []);
